...
1. Download the `Liquid.zip` from the [Releases](https://github.com/ruiyangzhou01/Liquid/releases) in [Liquid repository](https://github.com/ruiyangzhou01/Liquid/).
...
Turn to [Document](https://github.com/ruiyangzhou01/Liquid/blob/main/doc/Document.md) to find how to make your custom configuration for Liquid Theme.
